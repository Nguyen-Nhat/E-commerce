...
import org.ckxnhat.identity.config.security.CustomUserDetailsService;
 ...
 * @datetime 2024-07-23 23:32:21.644
 */
...
public class SecurityConfig {
    ...
    public RegisteredClientRepository registeredClientRepository(JdbcTemplate jdbcTemplate) {
        RegisteredClient registeredClient = RegisteredClient.withId("relive-messaging-oidc")
                ...
                .redirectUri("http://127.0.0.1:8087/login/oauth2/code/messaging-gateway-oidc")
                ...
                .tokenSettings(TokenSettings.builder()
                        ...
                        .reuseRefreshTokens(false)//reuseRefreshTokens: Whether to reuse refresh tokens
                        .build()
                )
                .build();
